const MeetYourMentor = () => {
  return (
    <div className="forBorderPadding bg-gradient-to-b from-[#D7CEA5] to-[#3D8361]  rounded-xl w-full mt-[6rem]">
      <div className="flex flex-col-reverse lg:flex-row  w-full bg-gradient-to-b from-[#013229] to-[#011F1A] rounded-xl ">
        <div className=" p-2 lg:w-3/5 lg:p-16 ">
          <h3 className="font-darker-grotesque font-extrabold text-4xl text-[#3D8361]">
            Meet your Mentor
          </h3>
          <h1 className="font-darker-grotesque text-6xl text-[#EDF1E4]">
            John Deo
          </h1>
          ...
          <p className="mt-6 text-[#D7CEA5] leading-10 font-normal text-base font-dm-sans">
